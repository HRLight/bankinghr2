<?php
  ...
  if($session->isUserLoggedIn(true)) {
    ...
    $userPosition=$current_user['Position'];

   switch ([$userlevel, $userDept, $userPosition]) {
...
<div class="container containerLog">
      ...
      <div class="wrapper wrapperLog">
        ...
        <form class="clearfix" method="post" action="auth_v2.php">
          ...
          <div class="pass"><a href="forgotp.php">Forgot password?</a></div>
          ...
          <div class="signup-link">
            All rights reserved. 
            <a href="#">AABank</a>
            <p> Terms and<a type="button" data-bs-toggle="modal" data-bs-target="#TermsModal"> &nbsp;Privacy policy.</a></p>
          </div>
        </form>
      </div>
  </div>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header bg-dark">
              <h5 class="modal-title text-white">TERMS AND POLICIES</h5>
              <button type="button" class="btn-close bg-light" data-bs-dismiss="modal" aria-label="Close">
              </button>
            </div>
            <div class="modal-body">
              <p><strong>Privacy Policy</strong></p>
            <p>Our Privacy Policy was last updated on May 14, 2022.</p>
            ...
            <li>
            <p><strong>"Business"</strong>, for the purpose of the AABTAPA (AABankTransAsia Privacy), refers to the Company as the legal entity that collects Consumers' personal information and determines the purposes and means of the processing of Consumers' personal information, or on behalf of which such information is collected and that alone, or jointly with others, determines the purposes and means of the processing of consumers' personal information.</p>
            </li>
            <li>
            <p><strong>"Company"</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to AABankTransAsia</p>
            ...
            <li>
            <p><strong>"Do Not Track"</strong> (DNT) is a concept that has been promoted by AABankTransAsia regulatory authorities, for the Internet industry to develop and implement a mechanism for allowing internet users to control the tracking of their online activities across websites.</p>
            </li>
            <li>
            ...
            <p>For the purposes of the AABTAPA, Personal Data means any information that identifies, relates to, describes or is capable of being associated with, or could reasonably be linked, directly or indirectly, with You.</p>
            </li>
            <li>
            <p><strong>"Sale"</strong>, for the purpose of the AABTAPA (AABanksTransAsia Privacy Act), means selling, renting, releasing, disclosing, disseminating, making available, transferring, or otherwise communicating orally, in writing, or by electronic or other means, a Consumer's personal information to another business or a third party for monetary or other valuable consideration.</p>
            </li>
            <li>
            ...
            <li>
            <p><strong>"Website"</strong> refers to [ BANKING AND FINANCE ], accessible from [ obms.online ]</p>
            </li>
            <li>
            ...
            <p><strong>AABTAPA Privacy</strong></p>
            <p>This privacy notice section for Filipino residents supplements the information contained in Our Privacy Policy and it applies solely to all visitors, users, and others who reside in the Philippines.</p>
            <p><strong>Categories of Personal Information Collected</strong></p>
            <p>We collect information that identifies, relates to, describes, references, is capable of being associated with, or could reasonably be linked, directly or indirectly, with a particular Consumer or Device. The following is a list of categories of personal information which we may collect or may have been collected from Filipino residents within the last twelve (12) months.</p>
            <p>Please note that the categories and examples provided in the list below are those defined in the AABTAPA. This does not mean that all examples of that category of personal information were in fact collected by Us, but reflects our good faith belief to the best of our knowledge that some of that information from the applicable category may be and may have been collected. For example, certain categories of personal information would only be collected if You provided such personal information directly to Us.</p>
            <ul>
            <li>
            ...
            <li>
            <p><strong>Category B: Personal information categories listed in the Philippine Customer Records statute.</strong></p>
            <p>Examples: A name, signature, Social Security number, physical characteristics or description, address, telephone number, passport number, driver's license or state identification card number, insurance policy number, education, employment, employment history, bank account number, credit card number, debit card number, or any other financial information, medical information, or health insurance information. Some personal information included in this category may overlap with other categories.</p>
            <p>Collected: Yes.</p>
            </li>
            <li>
            <p><strong>Category C: Protected classification characteristics under Philippines.</strong></p>
            ...
            <p>Under AABTAPA, personal information does not include:</p>
            <ul>
            <li>Publicly available information from government records</li>
            <li>Deidentified or aggregated consumer information</li>
            <li>Information excluded from the AABTAPA's scope, such as:
            <ul>
            </li>
            </ul>
            </li>
            ...
            <p>We may use or disclose personal information We collect for "business purposes" or "commercial purposes" (as defined under the AABTAPA), which may include the following examples:</p>
            <ul>
            ...
            <li>As described to You when collecting Your personal information or as otherwise set forth in the AABTAPA.</li>
            ...
            <li>Category B: Personal information categories listed in the Filipino Customer Records statute (Cal. Civ. Code § 1798.80(e))</li>
            <li>Category D: Commercial information</li>
            <li>Category F: Internet or other similar network activity</li>
            </ul>
            <p>Please note that the categories listed above are those defined in the AABTAPA. This does not mean that all examples of that category of personal information were in fact disclosed, but reflects our good faith belief to the best of our knowledge that some of that information from the applicable category may be and may have been disclosed.</p>
            <p>When We disclose personal information for a business purpose or a commercial purpose, We enter a contract that describes the purpose and requires the recipient to both keep that personal information confidential and not use it for any purpose except performing the contract.</p>
            <p><strong>Sale of Personal Information</strong></p>
            <p>As defined in the AABTAPA, "sell" and "sale" mean selling, renting, releasing, disclosing, disseminating, making available, transferring, or otherwise communicating orally, in writing, or by electronic or other means, a consumer's personal information by the business to a third party for valuable consideration. This means that We may have received some kind of benefit in return for sharing personal information, but not necessarily a monetary benefit.</p>
            <p>Please note that the categories listed below are those defined in the AABTAPA. This does not mean that all examples of that category of personal information were in fact sold, but reflects our good faith belief to the best of our knowledge that some of that information from the applicable category may be and may have been shared for value in return.</p>
            ...
            <p><strong>Your Rights under the AABTAPA</strong></p>
            <p>The AABTAPA provides Filipino residents with specific rights regarding their personal information. If you are a resident of Philippines, You have the following rights:</p>
            <ul>
            <li><strong>The right to notice.</strong> You have the right to be notified which categories of Personal Data are being collected and the purposes for which the Personal Data is being used.</li>
            <li><strong>The right to request.</strong> Under AABTAPA, You have the right to request that We disclose information to You about Our collection, use, sale, disclosure for business purposes and share of personal information. Once we receive and confirm your request, we will disclose to You:
            <ul>
            ...
            <p><strong>Exercising Your AABTAPA Data Protection Rights</strong></p>
            <p>In order to exercise any of Your rights under the AABTAPA, and if You are a Filipino resident, You can contact Us:</p>
            <ul>
            <li>By visiting this page on our website: [ obms.online  ]</li>
            <li>By sending us an email: [ systembanking6@gmail.com ]</li>
            </ul>
            <p>Only You, or a person registered with the Filipino Secretary of State that You authorize to act on Your behalf, may make a verifiable request related to Your personal information.</p>
            <p>Your request to Us must:</p>
            <ul>
            <li>Provide sufficient information that allows to reasonably verify You are the person about whom We collected personal information or an authorized representative</li>
            ...
            <p>The Service Providers we partner with (for example, our analytics or advertising partners) may use technology on the Service that sells personal information as defined by the AABTAPA law. If you wish to opt out of the use of Your personal information for interest-based advertising purposes and these potential sales as defined under AABTA law, you may do so by following the instructions below.</p>
            ...
            <p><strong>"Do Not Track" Policy as Required by Philippine Online Privacy Protection Act</strong></p>
            ...
            <p><strong>Your Philippine Privacy Rights</strong></p>
            <p>Under Philippine Privacy Act 10173, Filipino residents with an established business relationship with us can request information once a year about sharing their Personal Data with third parties for the third parties' direct marketing purposes.</p>
            <p>If you'd like to request more information under the Philippine Privacy Commission, and if you are a Filipino resident, You can contact us using the contact information provided below.</p>
            <p><strong>Philippine Privacy Rights for Minor Users (Revised Corporation Code of the Philippines 11232) </strong></p>
            <p> Revised Corporation Code of the Philippines 11232 allows Filipino residents under the age of 18 who are registered users of online sites, services or applications to request and obtain removal of content or information they have publicly posted.</p>
            <p>To request removal of such data, and if you are a Filipino resident, you can contact Us using the contact information provided below, and include the email address associated with Your account.</p>
            ...
            <ul>
            <li>By visiting this page on our website: [ obms.online ]</li>
            <li>By sending us an email: [ ssssystembanking6@gmail.com ]</li>
            </ul>
            <p></p>
            </div>
            <div class="modal-footer">
               <button type="Submit" name="Confirm" class="btn btn-success"><i class="fas fa-check"></i> Agree</button>
            </div>
          </div>
        </div>
      </div>
