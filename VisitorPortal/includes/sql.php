 ...
 function updateLastLogIn($user_id)
  ...
  /*--------------------------------------------------------------*/
   function page_require_level($require_level){
     ...
     function find_all_leave_requests(){
         global $db;
         $result =array();
         $sql = "SELECT leave_request.*,employees.*,departments.* FROM leave_request JOIN employees ON leave_request.employee_id = ";
         $sql .= "employees.employee_id JOIN departments ON employees.dept_id = departments.dept_id";
         $result = find_by_sql($sql);
         return $result;
         
     }
     function Call_resignation_Request(){
         global $db;
         $result =array();
  ...
  /*End of Sub notifications -----------------------------------------------------------*/
        ...
        function  notification_Budget(){
          ...
          function  Call_Pending_Request(){
            ...
            /*--------------------------------------------------------------*/
            /* call budget Budget request
            /*--------------------------------------------------------------*/
            function  Find_allBudget_Request(){
            global $db;
            $sql = "SELECT * FROM budget_request WHERE Co_Status = '102';" or die($mysqli->error);
            return find_by_sql($sql);
            }
