...
<div class="container-fluid">
 ...
 <div class="card shadow mb-3" >
                       ...
                       <div class="float-right">
                             ...
                             <a href="apply_complain.php?id=<?php echo $user['employee_id'] ?>" class="btn btn-primary btn-xs-block" type="button">
        ...
        File Complain
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th width="20%">Type of Complain</th>
            ...
            $sql = "SELECT * FROM complain WHERE employee_id = '$eid'; ";
            $res = $db->query($sql);
            $att = $res->fetch_assoc();
            $row = $res->num_rows;
            ...
            if($row>0){ do { ?>
                                  <tr>
                                    <td><?php echo $att['type_of_complain']; ?></td>
