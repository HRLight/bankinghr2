...
<?php
 ...
 $all_projects = find_all('mortgages')
?>
...
<nav class="breadcrumbs">
  ...
  <?php endif; ?>
  <a href="housingloan1.php" class="breadcrumbs__item is-active">Client Information for Housing Loan</a>
                        ...
                        <div class="row" style="padding-left:14px;">
                                <div class="col-md-12">
									...
									<div class="input-group mb-3 bareta">
									   ...
									   <button class="btn btn-secondary" id="btns"><a href="housingloan1.php" id="btnss">Refresh</a></button>
                                </div>
                            </div>
						</form>
						<hr>
                            <?php 
                                ...
                                if(isset($_POST['ref_no']) && isset($_POST['date_of_loan'])){
                                    ...
                                    $query = "SELECT * FROM mortgages WHERE ref_no= '$ref_no' AND date_of_loan= '$date_of_loan' ";
                            ...
                            <tbody>
                                ...
                                <td><?php echo $row['date_of_loan']?></td>
																...
																<td class="text-center">
																  <div class="btn-group">
																	<a href="done.php?id=<?php echo (int)$row['id'];?>"  class="btn btn-xs btn-warning" data-toggle="tooltip" title="Done">Done
