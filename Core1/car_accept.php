...
<?php
    ...
    $id = $_GET['id'];
    $query = "select * from `approve_car` where `id` = '$id'; ";
...
<br/><br/>
<hr>
<button class="btn btn-secondary" id="btns"><a href="carloan1.php" id="btnss">Back</a></button>
</div>
