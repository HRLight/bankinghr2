  ...
  <li>
    ...
    <div class="collapse" id="Collections">
      <ul class="navbar-nav ps-3">
        ...
        <li>
          <a href="carloans.php" class="nav-link px-3">
            <span class="me-2"
              ><i class="bi bi-person-lines-fill"></i></span>
                <span>CAR LOAN</span>
          </a>
        ...
        <li>
          <a href="businessloanform.php" class="nav-link px-3">
            <span class="me-2"
              ><i class="bi bi-person-lines-fill"></i></span>
        ...
        <li>
          <a href="personalloan.php" class="nav-link px-3">
            <span class="me-2"
              ><i class="bi bi-person-lines-fill"></i></span>
...
<!-- Loan Restructuring -->
  <li>
    ...
    <div class="collapse" id="Restructuring">
      <ul class="navbar-nav ps-3">
        <li>
          <a href="restructform.php" class="nav-link px-3">
            <span class="me-2"
              ><i class="bi bi-person-lines-fill"></i></span>
