<?php
  ...
  // Checkin What level user has permission to view this page
   ...
   $all_request_procurement = find_all('approved_housing_client')
?>
...
<nav class="breadcrumbs">
  ...
  <a href="#checkout" class="breadcrumbs__item is-active">Car Loan</a>
</nav>
...
<div class="col-md-12 mb-3 card-header" style="border: solid grey 1px">
	<div class="card">
		<div class="card-header">
			<span class="badge square-pill bg-success"><i class="bi bi-list"></i> House Loan </span>
		</div>
