  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
         <span class="badge rounded-pill bg-success"><i class="bi bi-table"></i> Admin Exam Questionaires and Answer Keys</span>
        
        <div class="text-end">
           <a href="admin_q_report.php?page=admin_exams.php" class="btn btn-primary btn-xs-block">
         <i class="bi bi-file-post"></i>
          Print Report
         </a>
          <a href="add-question.php?page=admin_exams.php" class="btn btn-primary btn-xs-block">
      ...
      <div class="card-body">
        ...
        $att_list = "SELECT questionaires.*, departments.dept_name,positions.pos_name FROM questionaires";
         ...
         $att_list .= " questionaires.pos_id = positions.pos_id WHERE questionaires.dept_id = '5'";
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit_question.php?id=<?php echo $row['id']; ?>&page=admin_exams.php" class="btn btn-sm btn-success pull-right">Edit</a>
