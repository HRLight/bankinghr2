...
<nav class="breadcrumbs">
    <a href="employee_eval.php" class="breadcrumbs__item">Back</a>
...
<div class="row" style="margin-bottom:10%; max-height: 600px;">
  ...
  <div class="card">
          ...
          <div class="col">
         <center> <h2><?php echo ucwords($info['first_name']).' '.ucwords($info['last_name']); ?> </h2></center>
        </div>
          </div>
        </div>
      </div>  
     ...
     <div class="col-md-12">
      <div class="row">
       ...
       <div class="col-md-8" style="margin-bottom: 30px;">
          ...
          <input disabled type="text" min="1" max="5" name="rel" value="<?php echo $info['remark'] ?>" style="width: 40vw;">
        </div>
