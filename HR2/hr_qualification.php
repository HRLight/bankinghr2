        ...
        <div class="table-responsive">
          <table
           ...
           <tbody>
            ...
            $att_list .= " job_qualifications.pos_id = positions.pos_id WHERE job_qualifications.dept_id = '1' OR";
            $att_list .= " job_qualifications.dept_id = '2' OR job_qualifications.dept_id = '3' OR job_qualifications.";
               $att_list .= "dept_id = '4'";
               ...
               $row = $res->fetch_assoc();
                    ...
                    ?>
                    <tr>
                      <td><?php echo str_replace('_',' ',$row['dept_name']); ?></td>
