  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
        ...
        <div class="text-end">
          <a href="hr_q_report.php?page=core_exams.php" class="btn btn-primary btn-xs-block">
      ...
      <div class="card-body">
        ...
        $att_list = "SELECT questionaires.*, departments.dept_name,positions.pos_name FROM questionaires";
         ...
         $att_list .= " questionaires.pos_id = positions.pos_id WHERE questionaires.dept_id = '1' OR";
        $att_list .= " questionaires.dept_id = '2' OR questionaires.dept_id = '3' OR questionaires.dept_id='4'";
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit_question.php?id=<?php echo $row['id']; ?>&page=hr_exams.php" class="btn btn-sm btn-success pull-right">Edit</a>
