  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
         <span class="badge rounded-pill bg-success"><i class="bi bi-table"></i> Finance Exam Questionaires and Answer Keys</span>
        <div class="text-end">
           <a href="finance_q_report.php?page=core_exams.php" class="btn btn-primary btn-xs-block">
            <i class="bi bi-file-post"></i>
          Print Report
         </a>
          <a href="add-emp-question.php?page=finance_emp_exams.php" class="btn btn-primary btn-xs-block">
      ...
      <div class="card-body">
        ...
        $att_list = "SELECT questionaires.*, departments.dept_name,positions.pos_name FROM questionaires";
         ...
         $att_list .= " questionaires.pos_id = positions.pos_id WHERE questionaires.dept_id = '10'";
