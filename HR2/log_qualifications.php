  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
        ...
        <div class="text-end">
          <a href="add-qualification.php?page=log_qualification.php" class="btn btn-primary btn-xs-block">
        ...
        <div class="table-responsive">
          <table
           ...
           <tbody>
            ...
            $att_list .= " job_qualifications.pos_id = positions.pos_id WHERE job_qualifications.dept_id = '8' OR";
            $att_list .= " job_qualifications.dept_id = '9'";
