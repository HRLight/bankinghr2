...
/*--------------------------------------------------------------*/
 ...
 /*--------------------------------------------------------------*/
  ...
  function find_all_user(){
   ...
   function find_trainees(){
      global $db;
      $results = array();
      $sql = "SELECT * FROM training_participants";
      $result =$db->query($sql);
      $num = $result->num_rows;
      return $num;
  }
   function find_emp_eval(){
      global $db;
      $results = array();
      $sql = "SELECT performance_review.*,employees.*,positions.*,departments.* FROM performance_review";
      $sql .= " JOIN employees ON performance_review.employee_id = employees.employee_id JOIN positions";
      $sql .= " ON employees.pos_id = positions.pos_id JOIN departments ON employees.dept_id = departments";
      $sql .= ".dept_id ";
      $result =$db->query($sql);
      $num = $result->num_rows;
      return $result;
  }
  function find_t_sched(){
      global $db;
      $results = array();
 ...
 function find_l_sched(){
  ...
  function find_new_trainee(){
      global $db;
      $results = array();
      $sql = "SELECT newhire_training.*,employees.* FROM newhire_training JOIN employees ON newhire_training.employee_id";
      $sql .= " = employees.employee_id";
      $result = find_by_sql($sql);
      return $result;
  }
  function find_all_orientation_approval(){
      global $db;
      $results = array();
      $sql = "SELECT orientation.*,employees.* FROM orientation JOIN employees ON orientation.employee_id ";
      $sql .= "= employees.employee_id WHERE orientation.status = 'manager approval'";
      $result = find_by_sql($sql);
      return $result;
  }

   function find_new_training_approval(){
      global $db;
      $results = array();
      $sql = "SELECT newhire_training.*,employees.* FROM newhire_training JOIN employees ON newhire_training.employee_id ";
      $sql .= "= employees.employee_id WHERE newhire_training.status = 'manager approval'";
      $result = find_by_sql($sql);
      return $result;
  }

 function find_all_orientation_sched(){
      global $db;
      $results = array();
      $sql = "SELECT orientation.*,employees.*,positions.*,departments.* FROM orientation JOIN employees ON orientation";
      $sql .= ".employee_id = employees.employee_id JOIN positions ON employees.pos_id = positions.pos_id JOIN departments";
      $sql .= " ON employees.dept_id = departments.dept_id";
      $result = find_by_sql($sql);
      return $result;
  }
  ...
  function find_all_learning_sched_approval(){
      global $db;
      $results = array();
      $sql = "SELECT * FROM seminar_sched WHERE status = 'manager approval'";
      $result = find_by_sql($sql);
      return $result;
  }
  /*--------------------------------------------------------------*/
