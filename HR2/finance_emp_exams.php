    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        $att_list = "SELECT emp_questionaires.*, departments.dept_name FROM emp_questionaires";
         ...
         $att_list .= " WHERE emp_questionaires.dept_id = '10'";
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit_emp_question.php?id=<?php echo $row['question_id']; ?>&page=finance_emp_exams.php" class="btn btn-sm btn-success pull-right">Edit</a>
                            <a href="delete_emp_question.php?id=<?php echo $row['question_id']; ?>&page=finance_emp_exams.php" class="btn btn-sm btn-danger pull-right">Delete</a>
                        </td>
                    </tr>
                    <?php
