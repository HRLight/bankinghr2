...
<nav class="breadcrumbs">
  ...
  <a href="succession-monitoring.php" class="breadcrumbs__item">Back</a>
  <a href="#checkout" class="breadcrumbs__item is-active">Add Successor Plan</a>
</nav>
<!-- /Breadcrumb -->
  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
        <span class="badge rounded-pill bg-primary"><i class="bi bi-plus"></i> Add Successor Plan</span>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-lg-12">
              ...
              <form action="hr2-codes.php" method="POST">
                <div class="container">
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    <label class="col-form-label col-md-4">Position</label>
                     ...
                     <div class="form-group row">
                    <label class="col-form-label col-md-4">Successor</label>
                    <div class="col-md-8">
                  ...
                  <div class="form-group row mt-10">
                    ...
                    <div class="col-md-8">
                      <button type="submit" name="addsuccessionplan" class="btn btn-primary text-white">Submit</button>
