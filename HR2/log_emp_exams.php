  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
        ...
        <div class="text-end">
          <a href="add-emp-question.php?page=log_emp_exams.php" class="btn btn-primary btn-xs-block">
      ...
      <div class="card-body">
        ...
        $att_list = "SELECT emp_questionaires.*, departments.dept_name FROM emp_questionaires";
         ...
         $att_list .= " WHERE emp_questionaires.dept_id = '8' OR emp_questionaires.dept_id = '9'";
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit_emp_question.php?id=<?php echo $row['question_id']; ?>&page=log_emp_exams.php" class="btn btn-sm btn-success pull-right">Edit</a>
                            <a href="delete_emp_question.php?id=<?php echo $row['question_id']; ?>&page=log_emp_exams.php" class="btn btn-sm btn-danger pull-right">Delete</a>
                        </td>
                    </tr>
                    <?php
