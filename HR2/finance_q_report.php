...
$sql = "SELECT questionaires.*, departments.dept_name,positions.pos_name FROM questionaires JOIN departments ON questionaires.dept_id = departments.dept_id JOIN positions ON questionaires.pos_id = positions.pos_id WHERE questionaires.dept_id = '10'";
$result = $db->query($sql);
...
<!DOCTYPE html>
<html>
<head>Finance Questionaires</title>
    ...
    <div class="">
      <div class="panel-heading clearfix">
        ...
        <strong>
          ...
          <span>Financials Applicants Questionaires And Answer Keys</span>
       </strong>
     </div>
     <div class="col-md-6">
     ...
     <a href="finance_exams.php" id="a" class="btn btn-danger">BACK</a>
     </div>
