  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
         <span class="badge rounded-pill bg-success"><i class="bi bi-table"></i>Finance Job Qualifications</span>
        <div class="text-end">
        ...
        <div class="table-responsive">
          <table
           ...
           <tbody>
            ...
            $att_list .= " job_qualifications.pos_id = positions.pos_id WHERE job_qualifications.dept_id = '10'";
