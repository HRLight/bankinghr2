  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
        <span class="badge rounded-pill bg-primary"><i class="bi bi-file-post"></i> Training Evaluation</span>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-lg-12">
              ...
              <form action="hr2-codes.php" method="POST">
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row mt-10">
                    ...
                    <div class="col-md-8">
                      <button type="submit" name="evaltraining" class="btn btn-primary text-white">Submit</button>
