<?php
  ...
  $sql = "SELECT newhire_training.*,employees.*,positions.*,departments.* FROM newhire_training JOIN employees ON ";
  $sql .= "newhire_training.employee_id = employees.employee_id JOIN positions ON employees.pos_id = positions";
...
<nav class="breadcrumbs">
  ...
  <a href="newhire_training.php" class="breadcrumbs__item">Schedules</a>
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <label class="col-form-label col-md-4">Date </label>
                      <div class="col-md-8">
                        <input type="text" name="tname" class="form-control" value="<?php echo $info['date_start']?>" disabled>
                    </div>
                  </div><br>
                  <div class="form-group row">
                    <label class="col-form-label col-md-4">Date </label>
                      <div class="col-md-8">
                        <input type="text" name="tname" class="form-control" value="<?php echo $info['date_end']?>" disabled>
                    </div>
                  </div><br>
...
<option value="<?php echo $fac['name_of_room'] ?>"><?php echo $fac['name_of_room']?></option>
                  ...
                  <div class="form-group row mt-10">
                    ...
                    <div class="col-md-8">
                      <button type="submit" name="setnewt" class="btn btn-primary text-white">Submit</button>
                      <a href="newhire_training.php" class="btn btn-secondary text-white" data-dismiss="modal">Back</a>
                    </div>
                  </div><br>
                </div>
                </div>
