           ...
           <?php foreach ($all_request_equipment as $loan):?>
                <tr>
                    ...
                    <td class="text-center">
                      <div class="btn-group">
                        <a href="approve-equipment-request.php?id=<?php echo $loan['id'];?>" class="btn btn-sm btn-success" style="margin-right: 5px;"><i class="bi bi-check"></i></a>
                           
                      <a href="decline_equipment_request.php?id=<?php echo $loan['id'];?>" class="btn btn-sm btn-danger"><i class="bi bi-x"></i></a>
                      </div>
                    </td>
                </tr>       
            <?php endforeach; ?>
