  ...
  <div class="col-md-3 mb-3">
   ...
   <div class="col-md-3 mb-3">
    <div class="card bg-success text-dark h-100">
      <div class="card-body py-10"><p> <?php echo "<h2>$pdOfacility</h2>"; ?><br> <span><i class="bi bi-list-columns"></i>Contract Request</span></p></div>
   ...
   <div class="col-md-3 mb-3">
    <div class="card bg-danger text-dark h-100">
      <div class="card-body py-10"><p> <?php echo "<h2>$pdOBudget_Request</h2>"; ?><br> <span><i class="bi bi-list-columns"></i>Budget Request</span></p></div>
