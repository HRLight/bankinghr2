      ...
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          <a
            ...
            aria-expanded="false"
          >
          <img src="uploads/users/<?php echo $user['image'];?>" width="30" height="30" class="rounded-circle"> <span class="badge square-pill bg-success"><?php echo remove_junk(ucfirst($user['name'])); ?></span>
     </a>
          </a>
...
<nav class="navbar-dark">
      <?php if($user['Position'] === 'administrative_manager'): ?>
        <!-- admin menu -->
      <?php include_once('admin_menu.php');?>

    <?php elseif($user['Position'] === 'administrative_staff'): ?>
        <!-- Special user -->
      <?php include_once('user_menu.php');?>

    <?php elseif($user['Position'] === 'Administrator'): ?>
        <!-- User menu -->
