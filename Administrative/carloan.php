...
<?php
 ...
 $all_projects = find_all('approve_car_client')
?>
...
<nav class="breadcrumbs">
  ...
  <a class="breadcrumbs__item is-active"> Car Loan</a>
</nav>
<!-- /Breadcrumb -->
<hr>
<br>
...
<a href="business.php"><button type="button" class="btn btn-success">Business Loan</button></a>
            ...
            <hr>
                            <?php 
                                ...
                                if(isset($_POST['id']) && isset($_POST['date_of_loan'])){
                                    ...
                                    $query = "SELECT * FROM approve_car_client WHERE id= '$id' AND date_of_loan= '$date_of_loan' ";
