...
<nav class="breadcrumbss">
		...
		<a href="housingloan.php"><button type="button" class="btn btn-light" checked>Housing Loan</button></a> 
		
		<a href="carloan.php"><button type="button" class="btn btn-light">Car Loan</button></a> 
		
		<a href="#"><button type="button" class="btn btn-light">Business Loan</button></a>
		
		<a href="personal-loan.php"><button type="button" class="btn btn-primary">Personal Loan</button></a>
</nav>
<hr class="lines">
