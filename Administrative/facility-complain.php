...
<nav class="breadcrumbs">
  ...
  <?php endif; ?>
  <a href="#checkout" class="breadcrumbs__item is-active">List of Facility Complain</a>
</nav>
<!-- /Breadcrumb -->
<br>
  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
        <span class="badge rounded-pill bg-success"><i class="bi bi-table"></i> Facility Complains Table</span>
      </div>
      <div class="card-body">
			...
			<td><?php if($facilitycomplain['status'] == 'approved'){ ?>
				...
				<td class="text-center"><?php echo remove_junk(ucfirst($facilitycomplain['date']));?></td>
                    <td class="text-center">
                       <a href="edit_facility_complain.php?id=<?php echo $facilitycomplain['id'];?>" class="btn btn-sm btn-success" style="margin-right: 5px;"><i class="bi bi-pencil"></i></a>  
                      
                      
                     <a href="archive-facility-complain.php?id=<?php echo $facilitycomplain['id'];?>" class="btn btn-sm btn-primary"><i class="bi bi-archive"></i></a>
