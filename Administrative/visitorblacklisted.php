...
<?php
	$page_title = 'Visitor Blacklisted';
...
<nav class="breadcrumbs">
  ...
  <?php endif; ?>
  <a href="visitorinformation.php" class="breadcrumbs__item is-active">List of visitor Blacklisted</a>
</nav>
<!-- /Breadcrumb ------------------------------------------------------------------------------------------------>
    ...
    <div class="card">
      <div class="card-header">
         <span class="badge box bg-success"><i class="bi bi-table"></i> Table of Visitor Blacklisted Person</span>
