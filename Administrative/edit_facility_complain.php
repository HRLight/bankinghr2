...
<?php
  $page_title = 'Edit Facility Complain';
...
<div class="row">
  ...
  $query = mysqli_query($conn, "SELECT * FROM facility_complain WHERE id = {$resignid}");
...
<div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
        <span class="badge rounded-pill bg-success"><i class="bi bi-pencil"></i> Edit Facility Complain</span>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-lg-7">
            <div class="card-box">
              <form action="edit-facility-complain.php" method="POST">
			  ...
			  <div class="form-group row">
                ...
                <div class="form-group row">
				  ...
				  <br>
                  <div class="form-group row">
                    <label class="col-form-label col-md-4">Company</label>
                    <div class="col-md-8">
                  ...
                  <br>
                  <div class="form-group row">
                    <label class="col-form-label col-md-4">Type of Facility</label>
                    <div class="col-md-8">
                      <input type="text" name="type_of_facility" value="<?php echo $row['type_of_facility']; ?>" class="form-control">
                    </div>
                  </div>
                  <br>
                  <div class="form-group row">
                    <label class="col-form-label col-md-4">Complain</label>
                    <div class="col-md-8">
                      <input type="text" name="complain" value="<?php echo $row['complain']; ?>" class="form-control">
                    </div>
                  </div>
                  <br>
                   <div class="form-group row">
				...
				<option value="reject">reject</option>				
                  ...
                  <div class="form-group row mt-10">
                    ...
                    <div class="col-md-8">
                      ...
                      <a href="facility-complain.php" class="btn btn-secondary text-white" data-dismiss="modal">Back</a>
                    </div>
                  </div>
                </form>
              </div>
