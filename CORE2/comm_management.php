  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
        <span class="badge rounded-pill bg-success"><i class="bi bi-table"></i> Communication Management</span>
     <div class="text-end">
                            <a href="comm_report.php" class="btn btn-primary float-end">Add Report</a>
     </div>
      </div>
...
// Checkin What level user has permission to view this page
 ...
 $groups = find_all('comm_management');
 $users_id = current_user()['id'];
// $result = find_vendor_by_id('comm_management',$users_id);
 $is_show = 1;
 $all_comm_management = find_all('comm_management');
?>
<?php
  if(isset($_POST['applicationform'])){
   ...
   if(empty($errors)){
       ...
       // remove_junk($db->escape(date('Y-m-d', strtotime($_POST['date_created']))));
        ...
        $query = "INSERT INTO comm_management (";
     ...
     <div class="panel-body">
      <head>
        ...
        <div id="ViewData" class="tabcontent">
            ...
            <tbody>
            <?php foreach($all_comm_management as $a_vendor): ?>
            <tr>
