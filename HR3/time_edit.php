<?php
	...
	$result = $conn->query("SELECT * FROM time_and_attendance WHERE time_id=$time_id");
						...
						<div class="jumbotron text-center">
							...
							<?php
								if(isset($_POST['update'])) {
									...
									$conn->query("UPDATE time_and_attendance set login_time='$login_time_post' WHERE time_id=$time_id");
									$conn->query("UPDATE time_and_attendance set logout_time='$logout_time_post' WHERE time_id=$time_id");
									...
									$conn->query("UPDATE time_and_attendance SET calculated_work='$result' WHERE time_id='$time_id'");
