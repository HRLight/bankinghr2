...
$id = $_GET['id'];
$sql = "SELECT employees.*,new_hires.*,positions.* FROM employees JOIN new_hires ON employees.employee_id = new_hires.employee_id JOIN positions ON employees.pos_id = positions.pos_id WHERE new_hires.employee_id = '$id';";
$result = $db->query($sql);
...
<nav class="breadcrumbs">
    <a href="training.php" class="breadcrumbs__item">Back</a>
  <a href="#" class="breadcrumbs__item is-active">Trainee info</a>
</nav>
...
<div class="row" style="margin-bottom:10%; max-height: 600px;">
  ...
  <?php } ?>
    ...
    <a href="training.php" class="btn btn-sm btn-danger">Back</a>
    </div>
      </div>
      </div>
    </div>
