...
if($result = $db->query($sql)){
  ...
  $to_email = $email['email'];
            ...
            $body .= "<p>Please upload your documents on the job portal to proceed on the next step</p><br>";
	...
	<div class="col">
     ...
     <div class="panel-body">
      <form method="post" action="final-evaluation.php?id=<?php echo $id; ?>">
        ...
        <?php $sql = "SELECT * FROM final_exam WHERE applicant_id = '$id'";
            $s = $db->query($sql);
            $score = $s->fetch_assoc(); ?>
        <div class="col-md-6" style="margin-bottom: 30px;">
          <div class="col-md-5">
          ...
          <input type="number"  min="0" max="100" value="<?php echo $score['score'] ?>" disabled><span>%</span>
          <input type="hidden"  name="exam" value="<?php echo $score['score'] ?>" >
        </div>
      	<div class="col-md-5">
