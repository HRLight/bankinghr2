...
$id = $_GET['id'];
$sql = "SELECT award_history.*, employees.*,positions.*,departments.* FROM award_history JOIN employees ON award_history.employee_id ";
$sql .= "= employees.employee_id JOIN positions ON employees.pos_id = positions.pos_id JOIN departments ON employees.dept_id = departments.dept_id WHERE award_history.employee_id = '$id' ";
$result = $db->query($sql);
...
<nav class="breadcrumbs">
   ...
   <a href="performance-management.php" class="breadcrumbs__item">Employees</a>
    <a href="view-past-evaluation.php?id=<?php echo $id ?>" class="breadcrumbs__item">Employee Evaluation</a>
