...
<div class="row" style="margin-bottom:10%; max-height: 600px;">
  ...
  <a href="print-learning.php?id=<?php echo $stat['employee_id'] ?>&award=<?php echo $stat['award'] ?>&date=<?php echo $stat['date'] ?>" class="btn btn-sm btn-success"  title="print certificate">Print Certificate</a>
    ...
    class="btn btn-danger btn-sm" ><span>Rejected   </span><i class="bi bi-x"></i></a>
             ...
             <?php }elseif($stat['status'] == 'printed'){ ?>

            <span>printed</span>
          <?php }else{  echo $stat['status'];} }else { ?>
                <a href="request-learning-certifiate.php?id=<?php echo $info['employee_id'];?>&date=<?php echo $info['date'];?>&title=<?php echo $info['title'];?>" class=" btn btn-sm btn-success"  title="">
