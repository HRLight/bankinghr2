...
$sql = "SELECT employees.*, contract_signing.*,positions.* FROM employees JOIN contract_signing ON employees.employee_id = contract_signing.employee_id JOIN positions ON employees.pos_id = positions.pos_id";
$result = $db->query($sql);
