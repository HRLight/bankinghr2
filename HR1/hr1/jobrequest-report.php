...
$sql = "SELECT job_vacancy.*,positions.*,departments.*,job_qualifications.* FROM job_vacancy JOIN positions ON job_vacancy.pos_id = positions.pos_id JOIN departments ON job_vacancy.dept_id = departments.dept_id JOIN job_qualifications ON positions.pos_id = job_qualifications.pos_id ";
$result = $db->query($sql);
