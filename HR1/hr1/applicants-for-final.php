    ...
    <div class="card">
      <div class="card-header">
        <span class="badge rounded-pill bg-success"><i class="bi bi-people"></i>Qualified Applicants for Final Interview</span>
         <div class="text-end">
          <a href="final_interview_report.php" class="btn btn-info btn-sm pull-right mr-2s"><i class="bi bi-file-post"></i> Print report</a>
         </div>
      </div>
      <div class="card-body">
       <table
        ...
        <?php do{ ?>
          <tr>
           <td class="text-center"><?php echo remove_junk(ucwords(str_replace('_',' ',$info['first_name']))).' '.remove_junk(ucwords($info['last_name']))?></td>
