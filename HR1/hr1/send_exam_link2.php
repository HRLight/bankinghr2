...
$sql = "INSERT INTO final_examinee (applicant_id,vkey) VALUES ('$id','$vkey')";
if($db->query($sql)){
...
$e_mail = $result->fetch_assoc();
   $to_email = $e_mail['email'];
            ...
            $body .= "<a href='https://www.obms.online/HR1/hr1/final_exam.php?id=".$id."&vkey=".$vkey."'>Click Here</a>";
