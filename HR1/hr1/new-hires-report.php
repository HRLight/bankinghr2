...
$sql = "SELECT employees.*, new_hires.*,positions.* FROM employees JOIN new_hires ON employees.employee_id = new_hires.employee_id JOIN positions ON employees.pos_id = positions.pos_id";
$result = $db->query($sql);
      ...
      <table class="table table-bordered table-striped">
        ...
        <?php if($row>0){ do{ 
          ...
          <tr>
           ...
           <td class="text-center"><?php echo remove_junk(ucwords($a_jobs['pos_name']))?></td>
