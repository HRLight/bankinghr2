...
$e_mail = $result->fetch_assoc();
 	 $to_email = $e_mail['email'];
            ...
            $body = "<p>Good day! We are glad to inform that you are qualified for initial interview.";
            $body .= " Please attend your scheduled date of interview. Failure to attend will result";
            $body .= " to failure of your application. </p> <br>";
            $body .= "<ul>";
