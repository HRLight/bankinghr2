...
<nav class="navbar-dark">
 ...
 $sql = "SELECT position FROM users WHERE id = '{$user['id']}'";
     ...
     ?>
      ...
      if($group_level['position'] === 'hr1_manager'){

      include_once('manager-menu.php');


       }elseif($group_level['position'] === 'recruitment_staff'){

      include_once('recruitment-menu.php');

      }elseif($group_level['position'] === 'applicant_managing_staff'){

       include_once('applicant-management-menu.php');

      }elseif($group_level['position'] === 'onboarding_staff'){

     include_once('newhire-onboard-menu.php');

     }elseif($group_level['position'] === 'performance monitoring_staff'){


    include_once('performance-management-menu.php');

      }elseif($group_level['position'] === 'social recognition_staff'){
