...
if(isset($_POST['updtplanbtn']))
{
    ...
    $e_tax = $_POST['e_tax'];
        ...
        $query = "UPDATE jobplan SET pos_id='$e_position',dept_id='$dept', jp_type='$e_type', jp_exp='$e_exp', jp_salrate='$e_salrate', jp_drate='$e_drate', jp_hrate='$e_hrate', jp_otrate='$e_otrate', jp_ph='$e_ph', jp_sss='$e_sss', jp_pi='$e_pi', jp_tax='$e_tax' WHERE jp_id='$id' ";
