...
<div class="row">
  ...
  <div class="col-md-12 mb-3">
    <div class="card">
	  ...
	  <div class="text-end">
          <a href="add_job_request.php" class="btn btn-primary btn-sm" type="button">
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table
            ...
            style="width: 100%" >
            <?php
            $query = "SELECT job_vacancy.*,departments.*,positions.* FROM job_vacancy JOIN departments ON job_vacancy.dept_id ";
			$query .= "= departments.dept_id JOIN positions ON job_vacancy.pos_id = positions.pos_id";
             $res = $db->query($query);
			$row = $res->fetch_assoc();
			$num = $res->num_rows;
            ?>
