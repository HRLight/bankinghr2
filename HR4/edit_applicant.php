...
<div class="row">
  ...
  $query = mysqli_query($conn, "SELECT employees.*,positions.* FROM employees JOIN positions ON employees.pos_id = positions.pos_id WHERE employees.employee_id = {$applid}");
