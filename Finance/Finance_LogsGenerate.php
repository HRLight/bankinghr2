...
<div class='console'>
    <div class='console-inner'>
      ...
      <div class="header"><h4>System Logs</h4></div>
      <div id="outputs" class="contentsofLogs">
        <?php
        $Login_Logs = file_get_contents('../Logs/Finance_Logs.txt');
  ...
  <script>
        function printDiv() {
            ...
            a.document.write('<body > <h1 style="font-family:sans-serif">System Logs </h1><h3><br>');
