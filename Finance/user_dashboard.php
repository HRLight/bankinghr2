...
$Disbursments=total_Disbursments();
foreach ($Disbursments as $key => $value) {
  $total_Disbursments = $value['Disbursment_total'];
}
$Chart1 = Sales_Chart();
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Total Loans</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">₱<?php echo number_format($total_Loans, 2, '.', ','); ?></div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                    Disbursments</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">₱<?php echo number_format($total_Disbursments, 2, '.', ','); ?></div>
                            </div>
                            <div class="col-auto">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="chart-area">
                            <canvas class="chart3" width="500" height="200"></canvas>
                        </div>
                    </div>
                </div>
            </div>
...
const datass2 = <?php echo json_encode($Sales) ?>;
</script>
