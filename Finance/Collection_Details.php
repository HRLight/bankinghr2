...
$TR=find_collection_transactions($AcoountNumber);
$Type=$_GET['Type'];
$Penalty=0;
$Date;
 ?>
...
<!-- for Determining what page the user came from-->
   ...
   <?php elseif ($PageName=='ListOfDeposits.php'): ?>
     <a href="ListOfDeposits.php" class="breadcrumbs__item">List Of Deposits</a>
...
<div class="col-md-13">
  ...
  <div class="AABank">
    <h3 class="fw-normal">Address:  Quirino Highway, Novaliches</h3>
    <h3 class="fw-normal">City: Quezon City</h3>
    <h3 class="fw-normal">T-Phone: 7799-6617</h3>
  </div>
  <div class="PurchaseOrder">
    <h3 class="fw-normal">Date: <?php echo $row['LS_Date']; ?></h3>
    <h3 class="fw-normal">INV Code: <?php echo $row['Co_Code']; ?></h3>
    <?php if (remove_junk($row['Name']) === 'Pending'): ?>
    <h3 class="fw-normal">Status : <span class="badge rounded-pill bg-danger"><?php echo remove_junk($row['Name']); ?></span></h3>
  <?php elseif (remove_junk($row['Name']) === 'Debit'):  ?>
   <h3 class="fw-normal">Status : <span class="badge rounded-pill bg-info"><?php echo "Approved"; ?></span></h3>
    <?php endif; ?>
  ...
  <div class="Address">
    <div class="leftTitleContent">
      <h3 class="fw-normal">Customer Name : <?php echo $row['LS_Account_name']; ?></h3>
      <h3 class="fw-normal">Address : <?php echo $row['LS_Address']; ?></h3>
      <h3 class="fw-normal">City : <?php echo $row['LS_City']; ?></h3>
      <h3 class="fw-normal">Country : <?php echo $row['LS_Country']; ?></h3>
    </div>
    <div class="RightTitleContent">
      <h3 class="fw-normal">Bank account number : <?php echo $row['A_Number']; ?></h3>
      <h3 class="fw-normal">Remaining Balance : <?= $row['LS_Remaining'] != 0 ? number_format($row['LS_Remaining'], 2, '.', ',') : number_format($row['LS_Amount'], 2, '.', ',');  ?></h3>
    </div>
  </div>
         ...
         <tbody>
           <?php foreach ($TR as $TR): ?>
             ...
             <tr>
               ...
               <td>₱<?php echo number_format($TR['P_Amount'], 2, '.', ','); ?></td>
...
<?php if ($PageName!="AccountsRecievable.php"): ?>
...
<?php elseif($PageName ==='ListOfDeposits.php'): ?>
  ...
  <div class="col-md-13">
    ...
    <div class="Address">
      ...
      <div class="RightTitleContent">
        <h3 class="fw-normal">Bank account number : <?php echo $row['A_Number']; ?></h3>
        <h3 class="fw-normal">Remaining Balance : <?php echo number_format($row['LS_Amount'], 2, '.', ','); ?> </h3>
      </div>
    </div>
    <div class="ThirdHeadSection">
     <h2 class="fw-bold">Cutomer Transactions</h2>
    </div>
    <br><br>
    <div class="TableContent">
          <table class="CollectionTbl">
...
<?php elseif($PageName ==='AccountsRecievable.php'): ?>
    ...
    <div class="col-md-13">
      ...
      <div class="Address">
        ...
        <div class="RightTitleContent">
          <h3 class="fw-normal">Bank account number : <?php echo $row['A_Number']; ?></h3>
          <h3 class="fw-normal">Remaining Balance : </h3>
        </div>
      </div>
      <div class="ThirdHeadSection">
       <h2 class="fw-bold">Cutomer Transactions</h2>
