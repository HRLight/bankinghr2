  ...
  <li>
    ...
    <div class="collapse" id="Collections">
      <ul class="navbar-nav ps-3">
        ...
        <li>
          <a href="Vip_List.php" class="nav-link px-3">
            <span class="me-2"
              ><i class="bi bi-card-list"></i></span>
            <!--Notification for Deposits -->
            <?php foreach ($notficationVIP as $notficationVIP): ?>
              <?php if ($notficationVIP['DepositsNotif']>=1): ?>
              <span class="badge1" data-badge="<?php echo $notficationVIP['DepositsNotif']; ?>">VIP List</span>
            <?php elseif ($notficationVIP['DepositsNotif']==0): ?>
              <span>VIP List</span>
            <?php endif; ?>
            <?php endforeach; ?>
          <!--EndNotification for Deposits -->
        ...
        <li>
          <a href="Collections_Deposits.php" class="nav-link px-3">
            <span class="me-2"
        ...
        <li>
          <a href="Collections_Loans.php" class="nav-link px-3">
            <span class="me-2"
              ><i class="bi bi-collection"></i
            ></span>
            <span>All Loans</span>
        ...
        <li>
          <a href="Charge_Basis.php" class="nav-link px-3">
            <span class="me-2"
  ...
  <li>
    ...
    >
      ...
      $totalnot=$notifDisburs['roCount']+$notifDisburs['poCount']+$notifDisburs['uCount'];
       if ($totalnot>=1): ?>
       <span class="badge1" data-badge="<?php echo $totalnot; ?>">Disbursement</span>
     <?php elseif ($notifCollection['notifCollection']==0): ?>
        ...
        <li>
          <a href="procurement.php" class="nav-link px-3">
            ...
            <?php foreach ($notificationProcurement as $notificationProcurement): ?>
              ...
              <span class="badge1" data-badge="<?php echo $notificationProcurement['procurementNotif']; ?>"> Procurement</span>
    ...
    <li>
      ...
      <div class="collapse" id="Budgets">
        <ul class="navbar-nav ps-3">
          ...
          <li>
            <a href="Budget_Request.php" class="nav-link px-3">
              <span class="me-2"
        ...
        <li>
          ...
          <div class="collapse" id="GeneralLedger">
            <ul class="navbar-nav ps-3">
              ...
              <li>
                <a href="Balance_Sheet.php" class="nav-link px-3">
                  <span class="me-2"
              ...
              <li>
                <a href="Ledger.php" class="nav-link px-3">
                  <span class="me-2"
              ...
              <li>
                <a href="Reports_Collection.php" class="nav-link px-3">
                  <span class="me-2"
                    ><i class="bi bi-journal-check"></i
                  ></span>
