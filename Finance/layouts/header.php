...
<!-- Notifcation Codes -->
    ...
    <?php $notficationVIP = notification_VIP(); ?>
...
<nav class="navbar-dark">
      <?php if($user['Position'] === 'financials_manager'): ?>
        <!-- admin menu -->
    ...
    <?php elseif($user['Position'] === 'collection_officer'): ?>
        <!-- Special user -->
      <?php include_once('user_menu.php');?>

    <?php elseif($user['Position'] === 'disbursment_officer'): ?>
        <!-- User menu -->
