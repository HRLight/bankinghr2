        ...
        <div class="table-responsive">
          <table
            ...
            <tbody>
             ...
             <td>
               <a href="Collection_Details.php?id=<?php echo $row['Co_Code']. "&Type=". urlencode($Type)."&PageName=". urlencode('ListOfDeposits.php'); ?>" class="btn btn-success bg-gradient btn-viewReciept"><i class="bi bi-file-earmark-post-fill"></i> Details</a></td>
              </tr>
             <?php endif; ?>
            <?php endforeach; ?>
