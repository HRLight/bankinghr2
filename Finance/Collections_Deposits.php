<?php
  ...
  // Checkin What level user has permission to view this page
   ...
   $Table="Deposit";
   $col=Collection_deposits_all();
   $repo=Collection_deposits_all();
?>
  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header">
        <span class="badge rounded-pill bg-success" style="font-size:14px;"><i class="bi bi-table"></i> All deposits Table</span>
     <div class="text-end">
      ...
      <div class="card-body">
        <div class="table-responsive">
         ...
         <tbody>
          ...
          <td>
            <a href="LoanPaymentsCol.php?id=<?php echo $col['Co_Code']. "&Tablename=". urlencode($Table)."&PageName=". urlencode('Collections_Deposits.php')."&ANumber=". urlencode($col['A_Number']);; ?>" class="btn btn-success bg-gradient btn-viewReciept"><i class="bi bi-file-earmark-post-fill"></i> Details</a></td>
           </tr>
         <?php endforeach; ?>
         </tbody>
         <tfoot>
