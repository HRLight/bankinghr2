           ...
           <tbody>
             ...
             <tr>
               ...
               <a href="DisbursmentDetails.php?id=<?php echo (int)$row['P_Code']. "&Tablename=". urlencode($row['P_Tablename'])."&PageName=". urlencode('AccountsPayables.php'); ?>" class="btn btn-primary"><i class="bi bi-list-task"></i> Details</a>
                <a href="Purchase_order.php?id=<?php echo (int)$row['P_Code']. "&Tablename=". urlencode($row['P_Tablename'])."&PageName=".urlencode('AccountsPayables.php')."&OldPageName=".urlencode('AccountsPayables.php'); ?>" class="btn btn-success"><i class="bi bi-journal-text"></i> View P.O</a>
               </td>
             </tr>
            <?php endforeach; ?>
         </tbody>
